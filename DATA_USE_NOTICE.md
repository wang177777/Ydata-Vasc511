...
Author-generated derivative materials in this repository, such as prompts, de-identified row-level scoring files, statistical summaries, reproducibility notes, web-platform audit logs, and representative de-identified raw-output audit excerpts, may be reused for research, verification, and educational purposes with appropriate citation.
...
Use the derived scoring, web-audit, raw-output audit subset, and supplementary files in this repository to verify model-evaluation results. Obtain original article figures or full texts directly from the source publications when needed.
